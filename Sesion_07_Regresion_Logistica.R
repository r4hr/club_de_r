...
ggplot(datos_rh, aes(x = average_montly_hours, y = factor(left), color = factor(left))) +
...
# Creo un dataframe de testing con las filas que no estÃ¡n incluidas en el Ã­ndice.
...
# El p-value de department de las mayorías de sus valores es mayor a 0.05, con lo cual la variable no 1es estadísticamente significativa
