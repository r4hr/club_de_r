...
.pull-left[<img src="Archivos/delirio_1.jpg" width=60% align="right" />]
.pull-right[<img src="Archivos/delirio_3.jpg" width=60% align="left" />]
...
```{r echo = FALSE, out.width="45%", message=FALSE, warning=FALSE}
mensuales %>%
  group_by(PUESTO) %>%
...
.pull-right[
```{r ref.label = 'bar-pila', echo=FALSE, message=FALSE, warning=FALSE, out.width="80%"}
```
]
...
.pull-right[
```{r ref.label = 'bar-fill', echo=FALSE, message=FALSE, warning=FALSE, out.width="85%"}
```
]
...
.pull-right[
```{r ref.label = 'bar-dodge', echo=FALSE, message=FALSE, warning=FALSE, out.width="85%"}
```
]
...
.pull-right[
```{r ref.label = 'col-basico', echo=FALSE, message=FALSE, warning=FALSE, out.width="85%"}
```
]
...
.pull-right[
```{r ref.label = 'col-order', echo=FALSE, message=FALSE, warning=FALSE, out.width="85%"}
```
]
...
.pull-right[
```{r ref.label = 'linea-basico', echo=FALSE, message=FALSE, warning=FALSE, out.width="85%"}
```
]
...
.pull-right[
```{r ref.label = 'linea-tune', echo=FALSE, message=FALSE, warning=FALSE, out.width="85%"}
```
]
...
.pull-right[
```{r ref.label = 'scatter-basic', echo=FALSE, message=FALSE, warning=FALSE, out.width="80%"}
```
]
